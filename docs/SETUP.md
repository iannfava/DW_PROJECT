# Guia Completo de Setup — Data Warehouse com dbt, Docker e Airflow

> Documentação passo a passo para instalar, configurar e rodar o projeto do zero. Siga cada etapa na ordem indicada.
> Para uma visão geral do projeto, arquitetura e resultados, veja o [README principal](../README.md).
